...
w1, b1 = init_weights(36, number_of_hidden), init_bias(number_of_hidden) #weights and biases from input to hidden layer
w2, b2 = init_weights(number_of_hidden, 6, logistic=False), init_bias(6) #weights and biases from hidden to output layer
...
plt.savefig('sample_cost_and_accuracy_3_layers_10000_epochs.png')
